<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNevbar.master" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="WebApplication1.Admin.WebForm9" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Admin1" runat="server">

     
     <h2>&nbsp;<strong>Orders Database</strong></h2>
    <p>
        &nbsp;</p>
     <p>
        This page is meant to manage the Orders Database used in the store</p>
<p>
<p>
        You are able to edit and insert in new Orders informatiion to the Orders Database. 
        Please note that this is the only way to Directly modify the Orders Database. Click on View Orders Database to start.
        </p>
<p>
        ...
        <table class="auto-style3" __designer:mapid="43f">
            <tr __designer:mapid="440">
                <td class="auto-style16" __designer:mapid="441">
                    <asp:Button ID="btnViewUsers" runat="server" OnClick="btnViewUsers_Click" Text="View Orders Database" Width="223px" />
                </td>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="ViewUsers" runat="server">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SomeeHost %>" SelectCommand="SELECT * FROM [Orders]" OldValuesParameterFormatString="original_{0}">
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SomeeHost %>" SelectCommand="SELECT * FROM [Orders]" OldValuesParameterFormatString="original_{0}">
            </asp:SqlDataSource>
            <div class="auto-style15">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="Aqua" BorderColor="#006666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataSourceID="SqlDataSource1" GridLines="Horizontal" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemsOrdered" HeaderText="ItemsOrdered" SortExpression="ItemsOrdered" />
                    </Columns>
