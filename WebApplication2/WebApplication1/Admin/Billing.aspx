<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNevbar.master" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="WebApplication1.Admin.WebForm6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Admin1" runat="server">

    
    
     <h2>&nbsp;<strong>Billling Database</strong></h2>
    <p>
        &nbsp;</p>
     <p>
        This page is meant to manage the Billing Database used in the store</p>
<p>
<p>
        You are able to edit and insert in new Billing informatiion to the Billing Database. 
        Please note that this is the only way to Directly modify the Billing Database. Click on View Billing Database to start.
        </p>
<p>
        ...
        <table class="auto-style3" __designer:mapid="43f">
            <tr __designer:mapid="440">
                <td class="auto-style16" __designer:mapid="441">
                    <asp:Button ID="btnViewUsers" runat="server" OnClick="btnViewUsers_Click" Text="View Billing Database" Width="188px" />
                </td>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="ViewUsers" runat="server">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SomeeHost %>" SelectCommand="SELECT * FROM [Billing]" OldValuesParameterFormatString="original_{0}">
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SomeeHost %>" SelectCommand="SELECT * FROM [Billing]" OldValuesParameterFormatString="original_{0}">
            </asp:SqlDataSource>
