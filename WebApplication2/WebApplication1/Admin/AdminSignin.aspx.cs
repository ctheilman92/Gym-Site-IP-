...
namespace WebApplication1
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT count(*) FROM Admin_Tbl WHERE Admin_Username='" + txtBoxUsername.Text + "' AND Admin_Passwd='" + txtBoxPassword.Text + "'";
            cmd.Connection = db;
            ...
            Session["adminname"] = txtBoxUsername.Text;
