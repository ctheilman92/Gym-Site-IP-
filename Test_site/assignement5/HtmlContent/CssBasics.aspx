<%@ Page Title="" Language="C#" MasterPageFile="~/WebsiteHtml.master" AutoEventWireup="true" CodeBehind="CssBasics.aspx.cs" Inherits="assignement5.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HtmlPlaceHolder" runat="server">
            ...
            <p>
                HTML was NEVER intended to contain tags for formatting a web page. HTML was created to <strong>describe the content</strong> of a web page, like:</p>
            <p>
            ...
            <p>
                To solve this problem, the World Wide Web Consortium (W3C) created CSS. CSS was created to specify the document&#39;s style, not its content.</p>
            <p>
                In HTML 4.0, and later, all formatting should be removed from the HTML page, and stored in separate CSS files.</p>
            <hr />
